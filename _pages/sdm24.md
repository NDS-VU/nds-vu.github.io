...
<img src="{{ site.url }}{{ site.baseurl }}/images/Yu.png" class="img-responsive" width="10%" style="float: left" />
...
<img src="{{ site.url }}{{ site.baseurl }}/images/Yijun.png" class="img-responsive" width="10%" style="float: left" />
...
<img src="{{ site.url }}{{ site.baseurl }}/images/Tong.png" class="img-responsive" width="10%" style="float: left" />
...
<img src="{{ site.url }}{{ site.baseurl }}/images/Xiaorui.png" class="img-responsive" width="10%" style="float: left" />
...
<img src="{{ site.url }}{{ site.baseurl }}/images/Jian.png" class="img-responsive" width="10%" style="float: left" />
...
<img src="{{ site.url }}{{ site.baseurl }}/images/Tyler.png" class="img-responsive" width="10%" style="float: left" />
